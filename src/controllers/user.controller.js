...
import jwt from "../utils/ApiResponse.js";
...
const registerUser = asyncHandler(async(req,res)=>{
    ...
    if(
      [fullname,email,username,password].some(f => !f || f.trim() === "")){
...
const refreshAccessToken = await asyncHandler(async(req,res)=> {
  const incomingRefershToken = req.cookies.refreshAccessToken || req.body.refreshAccessToken
...
const updateAccountDetails = asyncHandler(async(req,res) => {
  ...
  if(!fullName || !email) {
    throw new ApiError(400,"All feilds atr required")
  }
